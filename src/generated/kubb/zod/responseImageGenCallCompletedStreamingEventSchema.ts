...
/**
 * @description A streaming event that indicated an image generation tool call was completed.
 */
export const responseImageGenCallCompletedStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated an image generation tool call was completed.",
  );
