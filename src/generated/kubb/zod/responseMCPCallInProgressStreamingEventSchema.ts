...
/**
 * @description A streaming event that indicated an MCP call was in progress.
 */
export const responseMCPCallInProgressStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe("A streaming event that indicated an MCP call was in progress.");
