...
/**
 * @description A streaming event that indicated an MCP list tools call was completed.
 */
export const responseMCPListToolsCompletedStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated an MCP list tools call was completed.",
  );
