...
/**
 * @description A streaming event that indicated an MCP list tools call had failed.
 */
export const responseMCPListToolsFailedStreamingEventSchema = z
  .object({
    type: z
  ...
  .describe(
    "A streaming event that indicated an MCP list tools call had failed.",
  );
